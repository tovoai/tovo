...
export default function DesignA() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30 overflow-x-hidden pt-12">
      ...
      <nav className={`fixed top-12 w-full z-40 transition-all duration-300 ${isScrolled ? 'bg-slate-950/80 backdrop-blur-md border-b border-white/5 py-3' : 'bg-transparent py-5'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-mono text-indigo-400 bg-indigo-500/10 px-1.5 py-0.5 rounded-md w-max border border-indigo-500/20">v1.01.0 (시안 A)</span>
            </div>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 top-[120px] z-40 bg-slate-950/95 backdrop-blur-xl border-t border-white/5 p-6 flex flex-col gap-6 md:hidden">
